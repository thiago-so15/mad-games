  ...
  return (
    <div className="flex flex-col items-center gap-6 animate-[fade-in_0.3s_ease-out]">
      ...
      <div className="rounded-xl border border-zinc-700 bg-zinc-900/80 px-8 py-6 text-center">
        ...
        {bestTimeMs > 0 && <p className="mt-2 text-sm text-zinc-500">Mejor: <strong className="text-zinc-300">{formatTime(bestTimeMs)}</strong></p>}
        {isNewRecord && survivalTimeMs > 0 && <p className="mt-1 text-sm font-medium text-amber-400">¡Nuevo récord!</p>}
      </div>
