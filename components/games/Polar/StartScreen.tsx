...
export function StartScreen({ onPlay }: StartScreenProps) {
  return (
    <div className="flex flex-col items-center gap-8 animate-[fade-in_0.3s_ease-out]">
      <h2 className="text-2xl font-bold text-white">POLAR</h2>
      <p className="max-w-sm text-center text-zinc-400">
        Controlá un núcleo con polaridad positiva o negativa. Los obstáculos indican + o −. Si tu polaridad no coincide en el impacto, game over.
      </p>
      ...
      <p className="text-xs text-zinc-500">
        Espacio o Enter = cambiar polaridad · P = pausa
      </p>
    </div>
  );
}
