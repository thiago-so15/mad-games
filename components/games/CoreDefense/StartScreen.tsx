...
export function StartScreen({ onPlay }: StartScreenProps) {
  return (
    <div className="flex flex-col items-center gap-8 animate-[fade-in_0.3s_ease-out]">
      <h2 className="text-2xl font-bold text-white">Core Defense</h2>
      <p className="text-zinc-400 text-center max-w-sm">
        Defendé el núcleo. Rotá el escudo con ← → para bloquear los proyectiles. Racha de bloqueos = puntaje.
      </p>
      ...
      <p className="text-xs text-zinc-500">← → o A D para rotar · P: pausa</p>
    </div>
  );
}
