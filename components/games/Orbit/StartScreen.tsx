  ...
  return (
    <div className="flex flex-col items-center gap-8 animate-[fade-in_0.3s_ease-out]">
      ...
      <p className="text-zinc-400 text-center max-w-sm">
        Controlá un núcleo que orbita. Mantené presionado para órbita cerrada, soltá para amplia. Esquivá los obstáculos que salen del centro.
      </p>
      ...
      <p className="text-xs text-zinc-500">S o ↓ mantener = órbita cerrada · P o Espacio: pausa</p>
    </div>
  );
}
