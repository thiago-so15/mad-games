...
export function StartScreen({ onPlay }: StartScreenProps) {
  return (
    <div className="flex flex-col items-center gap-8 animate-[fade-in_0.3s_ease-out]">
      <h2 className="text-2xl font-bold text-white">Pulse Dash</h2>
      <p className="text-zinc-400 text-center max-w-sm">
        El corredor avanza solo. Usá dash (Espacio o ↑) para cambiar de carril. Evitá las zonas rojas.
      </p>
      ...
      <p className="text-xs text-zinc-500">Espacio o ↑: dash · P: pausa</p>
    </div>
  );
}
